...
#define	YY_DECL                                     \
  magma::yacc::Parser::token_type                   \
    example::Scanner::lex(                          \
	magma::yacc::Parser::semantic_type* yylval, \
	magma::yacc::Parser::location_type* yylloc, \
        magma::parse::parser &driver                \
    )
#endif
...
public:
    ...
    virtual magma::yacc::Parser::token_type lex(
	magma::yacc::Parser::semantic_type* yylval,
	magma::yacc::Parser::location_type* yylloc,
        magma::parse::parser &driver
	);
